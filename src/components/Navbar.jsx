...
export default function Navbar() {
    ...
    const getLinkClasses = (section) => {
        const baseClasses = "px-5 py-2 text-sm font-semibold rounded-full transition-all";
        const activeClasses = "text-white bg-purple-500/20 shadow-[0_0_15px_rgba(168,85,247,0.3)]";
        const inactiveClasses = "text-slate-400 hover:text-white hover:bg-white/10";
